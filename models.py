...
class EnvironmentCatalog(Base):
    ...
    ecr_repository_strategy = Column(String, default="shared")
    ecr_repository_provisioning_mode = Column(String, default="client-managed")
    ecr_require_existing_repository = Column(Integer, default=1)
    ecr_tag_mutability = Column(String, default="IMMUTABLE")
    ecr_scan_on_push = Column(Integer, default=1)
    ecr_encryption_type = Column(String, default="AES256")
    ecr_kms_key_arn = Column(String, nullable=True)
    ecr_expire_untagged_after_days = Column(Integer, default=14)
    ecr_retain_release_images = Column(Integer, default=50)
